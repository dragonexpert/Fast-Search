...

{
...

	{
        ...
        // Now we are going to check if a request for the same keywords has taken place within the last x minutes.
        ...
        $quickquery = $db->simple_select("searchlog", "sid", "dateline>=$cutoff", array("order_by" => "dateline", "order_dir" => "DESC", "limit" => 1));
